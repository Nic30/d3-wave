...
export function scrollbar(barHeight) {
	let selectorWidth = 20,
        onDrag = null,
	    scrollbarG, moverElm, width, height,
	    isScrollDisplayed, flatenedData,
        maxDepth, startPerc = 0.0;
            ...
            moverElm 
             ...
             moverElm.call(d3.drag().on("drag", function () {
                    ...
                    var y = parseInt(moverElm.attr("y")),
                        ny = y + d3.event.dy,
                        h = parseInt(moverElm.attr("height"));
    ...
    _scrollbar.registerWheel = function (elm) {
	    elm.on("wheel", function () {
	         ...
	         var y = parseInt(moverElm.attr("y")),
                 ny = Math.max(0, y + barHeight * step),
                 h = parseInt(moverElm.attr("height"));
    ...
    _scrollbar.isScrollDisplayed = function() {
	    if (flatenedData)
            isScrollDisplayed = barHeight * flatenedData.length > height;
